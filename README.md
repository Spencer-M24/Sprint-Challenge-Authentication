...
A:
The point of Sessions are use to send data across the server side non stop data  with requests


1. What does bcrypt do to help us store passwords in a secure manner.

A. Bcrypt javascript libary for protection using encyrption so secruring and making passwords safe and such before you put them stored.

1. What does bcrypt do to slow down attackers?
A.Bcrytped uses hash password and it slows down attacks because it non stop  hash  the passwords alot of times/

1. What are the three parts of the JSON Web Token?

A.The three important parts are the header signature and lastly the payload they all work hand and hand and is very important.
